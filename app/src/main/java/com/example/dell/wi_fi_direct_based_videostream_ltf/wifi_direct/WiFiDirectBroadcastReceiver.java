        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
            ...
            */
            ...
            if (networkInfo.isConnected()) {
              ...
              manager.requestGroupInfo(channel, new WifiP2pManager.GroupInfoListener() {//匿名内部类
                  @Override
                  public void onGroupInfoAvailable(WifiP2pGroup group) {
//                      Log.d(TAG, "onGroupInfoAvailable: ");
                      if (group!=null){
                          Log.d(TAG, "onGroupInfoAvailable: password is:"+group.getPassphrase());

                          //Log.d(TAG, "onGroupInfoAvailable:SSID ======="+group.getNetworkName());
